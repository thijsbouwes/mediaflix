...
class ProductResourceCest
{
    ...
    {
        $productOneId = $I->haveRecord(self::MODEL, ['name' => 'xbox', 'price' => '100.55']);
        $productTwoId = $I->haveRecord(self::MODEL, ['name' => 'playstation', 'price' => '222.22']);
        ...
        $I->seeResponseContainsJson(['id' => $productOneId, 'name' => 'xbox', 'price' => '100.55']);
        $I->seeResponseContainsJson(['id' => $productTwoId, 'name' => 'playstation', 'price' => '222.22']);
    ...
    public function createProduct(ApiTester $I)
    {
        ...
        $I->seeResponseContainsJson(['id' => 1, 'name' => 'xbox', 'price' => '100.55']);
    }
    ...
    public function updateProduct(ApiTester $I)
    {
        ...
        $I->seeRecord(self::MODEL, ['id' => 1, 'name' => 'playstation', 'price' => '222.22']);
    }
    ...
    public function deleteProduct(ApiTester $I)
    {
        ...
        $I->seeResponseCodeIs(HttpCode::NO_CONTENT);
        $I->dontSeeRecord(self::MODEL, ['name' => 'xbox', 'price' => '100.55']);
    }
}
