        ...
        <div class="row">
            <form role="form" method="POST" action="{{ url('/register') }}">
                ...
                <div class="input-field col col s12 m8 l4 offset-m2 offset-l4">
                    ...
                    <input id="name" type="text" class="validate" name="name" value="{{ old('name') }}" length="255" maxlength="255" required>
                </div>

                <div class="input-field col col s12 m8 l4 offset-m2 offset-l4">
                    <i class="material-icons prefix">mail_outline</i>
                    <label for="email">Email</label>
                    <input id="email" type="email" class="validate" name="email" value="{{ old('email') }}" length="255" maxlength="255" required>
                </div>
